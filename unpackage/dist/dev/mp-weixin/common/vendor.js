...
var _auth = __webpack_require__(/*! @/utils/auth */ 24);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //引入vue和vuex
...
var store = new _vuex.default.Store({ //全局变量定义
  ...
  actions: {
    ...
    // get user token
    codeToToken: function codeToToken(_ref,
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.codeToToken = codeToToken;exports.upUserInfo = upUserInfo;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}


function codeToToken(url, code) {
  var userVXcode = {
    "jsCode": code };
...
axios = /*#__PURE__*/function () {
  function axios(obj) {_classCallCheck(this, axios);
    ...
    this.EncrypBr = obj.EncrypBr || false;
    ...
    // 处理用户信息
                ...
                obj['data'] = Alldata_data;case 8:if (!(

                obj.formData != undefined)) {_context5.next = 13;break;}_context5.next = 11;return (
                  this.parameter_encrypt(obj.formData));case 11:_Alldata_data = _context5.sent;
                obj['formData'] = _Alldata_data;case 13:
                ...
                }_context5.next = 23;break;case 16:if (!(
                index == 2)) {_context5.next = 23;break;}if (!(
                obj.formData != undefined)) {_context5.next = 22;break;}_context5.next = 20;return (
                  this.parameter_encrypt(obj.formData));case 20:_Alldata_data2 = _context5.sent;
                obj['formData'] = _Alldata_data2;case 22:
                ...
                Alldata = {
                  ...
                  por_Br: this.por_Br };case 23:return _context5.abrupt("return",


                Alldata);case 24:case "end":return _context5.stop();}}}, _callee5, this);}));function url_dispose(_x5) {return _url_dispose.apply(this, arguments);}return url_dispose;}()


    /* 处理参数 并且加密 */ }, { key: "parameter_encrypt", value: function parameter_encrypt(
    arys) {
      if (!this.EncrypBr) return arys;
      var sig = this.sig;
      return new Promise(function (ra, re) {
        ...
        for (var i = 0; i < newkey.length; i++) {
          ...
          if (i == 0) {
            ...
            str_data += '&' + newkey[i] + '=' + arys[newkey[i]] + "&".concat(sig);
          } else {
            str_data += '&' + newkey[i] + '=' + arys[newkey[i]];
          }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/home/index": { "navigationStyle": "custom" }, "pages/huiHzs/index": { "navigationStyle": "custom" }, "pages/myItem/index": { "navigationStyle": "custom" }, "pages/itemDetail/index": { "navigationStyle": "custom" }, "pages/competition/index": { "navigationStyle": "custom" }, "pages/ranking/index": { "navigationStyle": "custom" }, "pages/share/index": { "navigationStyle": "custom" }, "pages/login/index": { "navigationStyle": "custom" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;
