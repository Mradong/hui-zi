<template>
	<view class="">
		<nav-bar ref="navBar" transparentFixedFontColor="#FFF" type="transparentFixed" title="我的简历">
		</nav-bar>
		...
		<view class="hui-zis">
			<view class="hui-zis-top">
				...
				<image src="../../static/images/2020_05_2.jpg" mode=""></image>
			</view>
			...
			<view class="hui-zis-items" v-if="isHuiItem">
				<view class="hui-zis-items-title">
					<text class="jingxuan">精选会子</text>
					<view class="all"><text>全部 </text>
						<image src="../../static/images/jiantou.svg" mode=""></image>
					</view>
					<image src="../../static/images/yunwen.png" mode=""></image>
				</view>
				<view class="hui-zis-items-item">
					<view class="custom-area">
						<view class="custom-area-item">
							<view class="tc thead">
								<view class="tc-r">代码：2020lyd13256465</view>
								<view class="tc-l"></view>
							</view>
							<view class="td">
								<view class="td-r">
									<view class="shouyi">100.00</view>
									<view class="">每月预计盈利</view>
								</view>
								<view class="td-l">
									<view class="td-l-tile">娜美500会</view>
									<view class="">每月会费：500</view>
									<view class="">剩余名额：5 人</view>
								</view>
							</view>
							<view class="tf">
						...
						<view class="custom-area-item">
							<view class="tc thead">
								<view class="tc-r">编码：2020lyd13256465</view>
								<view class="tc-l"></view>
							</view>
							<view class="td">
								<view class="td-r">
		...
		&-items {
			...
			&-title {
				...
				.jingxuan {
					...
					font-weight: 700;
					color: #7b00d8;
					text-shadow: 5upx 5upx 8upx #0e5dd4;
					text-align: left;
					position: relative;
					z-index: 99;
					margin-left: 30upx;
					...
					.tf {
						...
						&-l {
							...
							.tf-button {
								...
								background: linear-gradient(to top right, #ff6ba2, #7b00d8);
								border-radius: 4px;
								font-size: 26upx;
								line-height: 56upx;
								text-align: center;
